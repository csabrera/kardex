...
| **6C**    | ~~Maquinaria/Equipos~~ — **Removido del sistema** (2026-04-29). Se eliminó junto con Mantenimientos al confirmarse que no se usaba; sin Maintenance ni FuelDispatch, Equipment quedaba huérfano                           | ❌ **ELIMINADO**                                                                                                  | —        | 2026-04-29 |
...
| **6E**    | ~~Mantenimientos~~ — **Removido del sistema** (2026-04-29). 0 maintenances en producción, sin test E2E. Drop completo de tablas, enums, módulo, frontend, tabs, sidebar                                                   | ❌ **ELIMINADO**                                                                                                  | —        | 2026-04-29 |
